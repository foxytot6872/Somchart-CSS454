...
<body>
  ...
  <div class="upload-box">
    ...
    <input type="text" name="editFileName" value="<?= htmlspecialchars($Filename) ?>">

    <label>Edited Content</label>
    <textarea name="editFileContent" rows="6"><?= htmlspecialchars($Filecontent) ?></textarea>

    <input type="hidden" name="fileid" value="<?php echo $fileId ?>">

    <input type="submit" class="gotoeditfilebox" name="Edit_Submit" value="Save">
  </div>
  </form>
</body>
</html>